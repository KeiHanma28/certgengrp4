...
<body class="p-3 mb-2 ">
    ...
    <form action="/update" method="post">
        @csrf
        <input value="{{$user->user_id}}" type="number" name="user_id">
        <input value="{{$user->user_firstname}}" type="text" name="user_firstname">
        <input value="{{$user->user_lastname}}" type="text" name="user_lastname"><br><br>
        <input value="{{$user->user_email}}" type="text" name="user_email"><br><br>
        <input value="{{$user->user_type}}" type="number" name="user_type" hidden>
        <input value="{{$user->user_username}}" type="text" name="user_username">
        <input value="{{$user->user_password}}" type="text" name="user_password"><br><br>
